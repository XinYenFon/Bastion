...
function template_main()
{
	...
	<div class="tborder topic_table" id="messageindex">
		...
		{
			echo '
				<tr class="windowbg whos_viewing">
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if ($topic['new'] && $context['user']['is_logged'])
					echo '
							<a href="', $topic['new_href'], '" id="newicon' . $topic['first_post']['id'] . '"><span class="new_button">', $txt['new'], '</span></a>';
			...
			echo '
					...
					<td class="lastpost">
						<a href="', $topic['last_post']['href'], '" title="', $txt['last_post'], '"><i class="fas fa-file-export"></i></a>
			...
			{
				echo '
					<td class="moderation" align="center">';
