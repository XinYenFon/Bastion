...
function template_main()
{
	...
	if (!empty($context['members']))
	{
		...
		{
			echo '
				<tr ', empty($member['sort_letter']) ? '' : ' id="letter' . $member['sort_letter'] . '"', ' class="windowbg">
					<td>
		...
		if (!isset($context['disabled_fields']['website']))
			echo '
					<td>', $member['website']['url'] != '' ? '<a href="' . $member['website']['url'] . '" target="_blank" rel="noopener noreferrer" class="new_win"><img src="' . $settings['images_url'] . '/www.gif" alt="' . $member['website']['title'] . '" title="' . $member['website']['title'] . '"></a>' : '', '</td>';
